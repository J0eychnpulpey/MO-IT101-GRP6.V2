...
// Calls the readEmployeesFromFile method of EmployeeFileReader to read employee data from the CSV and store it in a list of Employee objects.
            List<Employee> employees = reader.readEmployeesFromFile("/home/johnpaul/Documents/motorphversion2/src/main/resources/MotorPH Employee Data - Employee Details.csv");  
