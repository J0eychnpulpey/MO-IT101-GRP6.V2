...
public class EmployeeAttendanceFileReader {
    public final String filename = "/home/johnpaul/Documents/motorphversion2/src/main/resources/AttendancerecordmotorPhversion2.2.txt"; // Stores the fixed path for the attendance data file.
