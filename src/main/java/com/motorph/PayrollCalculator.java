...
public class PayrollCalculator {
    ...
    public double calculateEmployeeTotalHoursWorked(String empId, int month, int year, double grossPay) {
        ...
        List<AttendanceRecord> attendanceData = attendanceFileReader.readEmployeeAttendanceFile(empId, "/home/johnpaul/Documents/motorphversion2/src/main/resources/AttendancerecordmotorPhversion2.2.txt", month, year);

        // 2. Get Hourly Rate from Employee
        EmployeeFileReader employeeFileReader = new EmployeeFileReader();
        Employee employee = employeeFileReader.findEmployeeById(empId, "/home/johnpaul/Documents/motorphversion2/src/main/resources/MotorPH Employee Data - Employee Details.csv");
