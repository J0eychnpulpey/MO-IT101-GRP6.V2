...
public class Employee {
    ...
    // Constructor
    public Employee(String empNo, String lastName, String firstName, String birthday , String address, String phoneNo, String sssNo, String philHealthNo, String tinNo, String pagibigNo, String status, String position, String supervisor, double basicSalary, double riceSubsidy, double phoneAllowance, double clothingAllowance, double semiMonthlyRate, double hourlyRate) {
        this.empNo = empNo;
